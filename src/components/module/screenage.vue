  ...
  <div class="screenage-wrapper">
      ...
      <div class="list">
        <div class="litem">
          <div class="img-wrap">
            ...
            <van-uploader name="idFront" class="file" :after-read="afterRead" :max-size='4194304' @oversize="overSize"/>
          </div>
        ...
        <div class="litem">
          <div class="img-wrap">
            ...
            <span class="camera"></span>
            <van-uploader class="file" :after-read="afterRead" name="idReverse" :max-size='4194304' @oversize="overSize"/>
          </div>
    ...
    <div class="item">
      ...
      <div class="list">
        <div class="litem">
          <div class="img-wrap">
            <img class="img" v-if="!imgList.vehicleLicenseFront" src="../../assets/upload/vehicle-license.png" alt="">
            <img class="img sample" else :src="imgList.vehicleLicenseFront.content" alt="">
            <span class="camera"></span>
            <van-uploader class="file" :after-read="afterRead" name="vehicleLicenseFront" :max-size='4194304' @oversize="overSize"/>
          </div>
          <p class="instr">请上传行驶证正本</p>
        </div>
        <div class="litem">
          <div class="img-wrap">
            <img class="img" v-if="!imgList.vehicleLicenseReverse" src="../../assets/upload/vehicle-license.png" alt="">
            <img class="img sample" else :src="imgList.vehicleLicenseReverse.content" alt="">
            <span class="camera"></span>
            <van-uploader class="file" :after-read="afterRead" name="vehicleLicenseReverse" :max-size='4194304' @oversize="overSize"/>
          </div>
    ...
    <div class="item">
      ...
      <div class="list">
        <div class="litem"
          v-for="(item, index) in imgList.carImgs"
          :key="index">
          <div class="img-wrap">
        ...
        <div class="litem">
          <div class="img-wrap">
            ...
            <van-uploader
              ...
              name="carImgs" :max-size='4194304' @oversize="overSize"/>
          </div>
          <p class="instr">请上传车辆右前侧<br>45度照片</p>
        </div>
      </div>
    </div>
    <div class="item">
      ...
      <div class="list">
        <div class="litem"
          v-for="(item, index) in imgList.otherImgs"
          :key="index">
          <div class="img-wrap">
            <img class="img" :src="item.content" alt="">
        ...
        <div class="litem">
          <div class="img-wrap">
            ...
            <van-uploader
              ...
              multiple
              :after-read="afterRead"
              name="otherImgs" :max-size='4194304' @oversize="overSize"/>
          </div>
        </div>
      </div>
    </div>
        ...
        .litem{
          ...
          .img-wrap{
            ...
            .camera{
              ...
              height: 40px;
              border-radius: 50%;
              background: rgba(0,0,0,.5) url(../../assets/camera.png) no-repeat center center;
