  ...
  <div class="hello">
    ...
    <div class="upload">
      ...
      <div class="upload_warp_text">
        选中{{imgList.length}}张，共{{imgList.length}}张
      </div>
      ...
      <div class="upload_warp_img" v-show="imgList.length!=0">
        <div class="upload_warp_img_div" v-for="(item,index) in imgList"
          ...
          <div class="upload_warp_img_div_top">
            ...
            <img src="../../assets/upload/del.png" class="upload_warp_img_div_del" @click="fileDel(index)">
          </div>
...
<script>
  export default {
    ...
    mounted(){
      ...
      this.imgUrl = this.imgList[0].file.src
      console.log("-============")
