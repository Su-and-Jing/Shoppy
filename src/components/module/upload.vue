  ...
  <div class="hello">
    ...
    <div class="upload">
      <div class="upload_warp">
        ...
        ></div>
        <div class="pictTxt" v-show="show">拖动图片到此处上传</div>
      </div>
      <div class="upload_warp_text">共{{imgList.length}}张，还能上传{{limit}}张</div>
      <input
    ...
    <!-- <div v-for="(item,index) in imgList" style="text-align: left" :key="index">
...
export default {
  ...
  methods: {
    ...
    upImgList() {
      console.log(this.imgList);
      this.$emit("upImgList", this.imgList);
    },
    fileDel(index) {
