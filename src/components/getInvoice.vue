        ...
        <van-cell-group class="cell-group">
          <div class="invoice-type van-hairline--bottom">
            ...
            <van-radio-group v-model="invoiceType">
              ...
              <van-radio name="2">纸质增值税专票</van-radio>
            </van-radio-group>
          </div>
      ...
      <div class="more-info">
        ...
        <van-cell-group>
          <van-field
            label="备注说明"
            v-model="descr"
            placeholder="请填写备注说明（非必填）"/>
          <van-field
            label="单位地址"
            v-model="unitAddress"
            placeholder="请填写单位地址（非必填）"/>
         <van-field
            label="电话号码"
            v-model="phoneNumber"
            placeholder="请填写电话号码（非必填）"/>
          <van-field
            label="开户银行"
            v-model="depositBank"
            placeholder="请填写开户银行（非必填）"/>
          <van-field
            label="银行账户"
            v-model="accountBank"
            placeholder="请填写银行账户（非必填）"/>
